...
export function initExposure(): void {
  ...
  contextBridge.exposeInMainWorld('kubernetesRestartCurrentContext', async (): Promise<ContextGeneralState> => {
    return ipcInvoke('kubernetes-client:restartCurrentContext');
  });
